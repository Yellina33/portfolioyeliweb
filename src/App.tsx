...
const UxDesignIcon = () => (
 <svg width="130" height="130" viewBox="0 0 73 74" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect x="30.0786" y="14" width="41" height="42.5375" transform="rotate(45 30.0786 14)" fill="url(#paint0_linear_2780_388)" fill-opacity="0.44"/>
<circle cx="44" cy="28.9914" r="20.5" transform="rotate(45 44 28.9914)" fill="#D9D9D9"/>
<circle cx="44" cy="28.9914" r="20.5" transform="rotate(45 44 28.9914)" fill="url(#paint1_linear_2780_388)"/>
<path d="M57.566 42.6981C50.0737 50.1904 37.9263 50.1904 30.434 42.6981C22.9417 35.2058 22.9417 23.0584 30.434 15.5661C37.9263 8.07375 50.0737 8.07375 57.566 15.5661C65.0583 23.0584 65.0583 35.2058 57.566 42.6981Z" fill="url(#paint2_linear_2780_388)"/>
<path d="M35.368 35.6334L41.6333 29.3681M49.523 26.582L47.6476 32.2084C47.6176 32.2986 47.5664 32.3802 47.4982 32.4464C47.43 32.5125 47.3468 32.5612 47.2557 32.5884L35.7589 36.0056C35.6553 36.0363 35.5453 36.0381 35.4407 36.0107C35.3362 35.9832 35.2413 35.9277 35.1661 35.85C35.091 35.7724 35.0386 35.6756 35.0147 35.5702C34.9907 35.4649 34.9962 35.3549 35.0303 35.2524L38.7635 24.0548C38.7903 23.9744 38.834 23.9007 38.8918 23.8387C38.9495 23.7767 39.02 23.7278 39.0983 23.6954L44.4017 21.5118C44.5095 21.4673 44.6281 21.4557 44.7425 21.4785C44.8569 21.5012 44.962 21.5574 45.0446 21.6398L49.3803 25.9775C49.4578 26.0551 49.5123 26.1527 49.5375 26.2595C49.5627 26.3662 49.5577 26.4779 49.523 26.582Z" stroke="white" stroke-width="1.12687" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M49.6394 26.2354L52.4235 23.4503C52.7926 23.081 53 22.5803 53 22.0582C53 21.5361 52.7926 21.0354 52.4235 20.6661L50.3364 18.577C50.1535 18.3941 49.9364 18.249 49.6975 18.15C49.4586 18.051 49.2025 18 48.9438 18C48.6852 18 48.4291 18.051 48.1901 18.15C47.9512 18.249 47.7341 18.3941 47.5513 18.577L44.7671 21.3622M43.7216 27.279C43.5844 27.1419 43.4216 27.0331 43.2424 26.9589C43.0632 26.8848 42.8711 26.8466 42.6772 26.8467C42.4833 26.8467 42.2912 26.8849 42.1121 26.9592C41.9329 27.0335 41.7701 27.1423 41.633 27.2795C41.4959 27.4166 41.3871 27.5795 41.313 27.7587C41.2388 27.9379 41.2006 28.1299 41.2007 28.3239C41.2007 28.5178 41.239 28.7099 41.3132 28.889C41.3875 29.0682 41.4963 29.231 41.6335 29.3681C41.9105 29.645 42.2862 29.8005 42.6779 29.8004C43.0696 29.8003 43.4452 29.6446 43.7221 29.3676C43.999 29.0906 44.1545 28.7149 44.1544 28.3232C44.1543 27.9315 43.9986 27.5559 43.7216 27.279Z" stroke="white" stroke-width="1.12687" stroke-linecap="round" stroke-linejoin="round"/>
<defs>
<linearGradient id="paint0_linear_2780_388" x1="50.6911" y1="-6.28848" x2="48.5698" y2="60.1796" gradientUnits="userSpaceOnUse">
<stop stop-color="#D70B5D"/>
<stop offset="0.65818" stop-color="#F2D6E2"/>
<stop offset="0.91493" stop-color="white"/>
</linearGradient>
<linearGradient id="paint1_linear_2780_388" x1="30.699" y1="12.3308" x2="53.1873" y2="47.7773" gradientUnits="userSpaceOnUse">
<stop stop-color="#FFE092"/>
<stop offset="1" stop-color="#E3A302"/>
</linearGradient>
<linearGradient id="paint2_linear_2780_388" x1="57.566" y1="15.5661" x2="30.434" y2="42.6981" gradientUnits="userSpaceOnUse">
  ...
  const projects: Project[] = [
    {
      ...
      description: "Complete user experience overhaul for different e-commerce platforms as part of my internships immersion. Participation in different team projects using the Agile methodology and ",
    ...
    },
    {
      ...
      description: "WordPress integration for the painting artist Sugaï to promote and showcase his works in illustration, mural painting, and artistic canvases. Integration using WordPress's robust features to create a user-friendly, customizable, and functional components.",
    ...
    },
    {
      ...
      description: "Website for a plumbing service company based in Lille. This project includes the design of an intuitive user journey, the construction of pages and components, and optimization of content for enhanced visibility and SEO performance.",
    ...
    },
    {
      ...
      description: "Complete visual identity design for a business of honey products startup",
    ...
    },
    {
      ...
      description: "Design of CD cover and typographic logo for a music project.",
    ...
    {
      title: "Album Mixing",
      description: "Audio production, voice recording and mixing for the artist Sugaï.",
    ...
    },
    {
      ...
      description: "Prototype of an integrated desktop application for education and training management. It includes the visualization of student progress, a list of courses, results, and feedback from students.",
    ...
    },
    {
      ...
      description: "Wireframe and prototype of a desktop application aiming to manage and organize candidates applications for programs on IT careers.",
    ...
    },
    {
      ...
      description: "Participation in a complete branding and prototyping project of a platform dedicated to offering courses and training on digital careers.",
    ...
    <div className="font-poppins">
      ...
      <header className="min-h-screen bg-gradient-primary text-white flex items-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <p className="text-xl mb-8 max-w-2xl">Crafting digital experiences through design, development, and sound</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="w-full h-[500px] rounded-2xl overflow-hidden items-center justify-center">
                <img 
                  src="public/images/image hero.jpg" 
                  alt="Profile" 
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                For the last five years, I have worked on designing apps and websites. I've participated on a variety of interesting and challenging projects using my skills in UX/UI design, media communication and translation. These projects have allowed me to work on the creation of user-friendly experiences, combining the technical principles of design with informed decisions based on interactions and responses from users.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                In addition to design, I am passionate about music. I have spent several years writing, singing, and producing sound for friends and personal projects. This love for music enhances my creativity and inspires me to build products that connect with people. I believe that design and music are not just professions; they are profound forms of communication that can touch lives and foster coopération and engagement.
              </p>
              <a 
                href="#work" 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Creating intuitive and visually appealing user interactions through wireframing and prototyping</p>
            </div>
            <div className="text-center p-6">
              <div className="w-auto h-auto full flex items-center justify-center mx-auto mb-4">
                <WebDesignIcon />
              ...
              <p className="text-gray-600">Responsive and modern website design and creation of content for digital platforms</p>
            </div>
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Tailored WordPress themes and content integration with enhanced functionnality through plugins and development tools</p>
            </div>
            <div className="text-center p-6">
              <div className="w-auto h-auto full flex items-center justify-center mx-auto mb-4">
                <MusicProductionIcon />
              ...
              <p className="text-gray-600">Audio production and mixing of music, voice-over recording for audiovisual projects</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2 rounded-lg text-gray-900 h-32"
                  required
                ></textarea>
              </div>
              <button
                type="submit"
                className="bg-secondary text-gray-900 px-8 py-3 rounded-lg font-semibold flex items-center justify-center hover:bg-opacity-90 transition-colors duration-300"
              >
                Send Message
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-4 text-center">
          <p>&copy; {new Date().getFullYear()} YeliWeb Portfolio. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
